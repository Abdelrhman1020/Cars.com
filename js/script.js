...
const product1=new products('Mercedes AMG GT 2023','500000 $','Mercedes','images/product1.jpg',1);
const product2=new products('Mercedes AMG GT-C','370000 $','Mercedes ','images/product2.jpg',2);
const product3=new products('Mercedes AMG GT-R ','350000 $','Mercedes','images/product3.jpg',3);
const product4=new products('AUDI A7 2021','150000 $','AUDI','images/product4.jpg',4);
const product5=new products('AUDI Q8 2023','195000 $','AUDI','images/product5.jpg',5);
const product6=new products('AUDI RS7 2023','200000 $','AUDI','images/product6.jpg',6);
const product7=new products('BMW M2 2023',' 300000 $','BMW','images/product7.jpg',7);
const product8=new products('BMW M8 2021','260000 $','BMW','images/product8.jpg',8);
const product9=new products('BMW M8 Competition','200000 $','BMW','images/product9.jpg',9);
